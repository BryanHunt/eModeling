...
package org.eclipselabs.emodeling.rs.mongo.junit.tests;
...
import org.eclipselabs.emodeling.rs.mongo.MongoResourceSetFactoryComponent;
 ...
 * 
 */
public class TestMongoResourceSetFactoryComponent
{
	private MongoResourceSetFactoryComponent resourceSetFactory;

	@Before
	public void setUp()
	{
		resourceSetFactory = new MongoResourceSetFactoryComponent();
	}
