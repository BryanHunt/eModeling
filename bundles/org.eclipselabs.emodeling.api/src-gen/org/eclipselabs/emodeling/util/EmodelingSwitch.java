...
import org.eclipselabs.emodeling.*;
 ...
 * @generated
 */
public class EmodelingSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case EmodelingPackage.ECOLLECTION:
      {
      ...
      case EmodelingPackage.ECONTAINMENT_COLLECTION:
      {
      ...
      case EmodelingPackage.EREFERENCE_COLLECTION:
      {
