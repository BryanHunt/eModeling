 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.eclipselabs.emodeling.log.LogFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel suppressInterfaces='true' basePackage='org.eclipselabs.emodeling'"
 * @generated
 */
public class LogPackage extends EPackageImpl
{
   ...
   * @generated
   */
  public static final String eNS_URI = "org.eclipselabs.emodeling.log";
   ...
   * @generated
   */
  public static final LogPackage eINSTANCE = org.eclipselabs.emodeling.log.LogPackage.init();

  /**
   * The meta object id for the '{@link org.eclipselabs.emodeling.log.LogEntry <em>Entry</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipselabs.emodeling.log.LogEntry
   * @see org.eclipselabs.emodeling.log.LogPackage#getLogEntry()
   * @generated
   */
  ...
  /**
   * The meta object id for the '{@link org.eclipselabs.emodeling.log.LogLevel <em>Level</em>}' enum.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipselabs.emodeling.log.LogLevel
   * @see org.eclipselabs.emodeling.log.LogPackage#getLogLevel()
   * @generated
   */
   ...
   * <!-- end-user-doc -->
   * @see java.util.Date
   * @see org.eclipselabs.emodeling.log.LogPackage#getDate()
   * @generated
   */
   ...
   * @see org.eclipselabs.emodeling.log.LogPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private LogPackage()
  ...
  /**
   * Returns the meta object for class '{@link org.eclipselabs.emodeling.log.LogEntry <em>Entry</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipselabs.emodeling.log.LogEntry#getLevel <em>Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Level</em>'.
   * @see org.eclipselabs.emodeling.log.LogEntry#getLevel()
   * @see #getLogEntry()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipselabs.emodeling.log.LogEntry#getCreatedOn <em>Created On</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Created On</em>'.
   * @see org.eclipselabs.emodeling.log.LogEntry#getCreatedOn()
   * @see #getLogEntry()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipselabs.emodeling.log.LogEntry#getMessage <em>Message</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Message</em>'.
   * @see org.eclipselabs.emodeling.log.LogEntry#getMessage()
   * @see #getLogEntry()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipselabs.emodeling.log.LogEntry#getExceptionMessage <em>Exception Message</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Exception Message</em>'.
   * @see org.eclipselabs.emodeling.log.LogEntry#getExceptionMessage()
   * @see #getLogEntry()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipselabs.emodeling.log.LogEntry#getExceptionStack <em>Exception Stack</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Exception Stack</em>'.
   * @see org.eclipselabs.emodeling.log.LogEntry#getExceptionStack()
   * @see #getLogEntry()
   * @generated
   */
  ...
  /**
   * Returns the meta object for enum '{@link org.eclipselabs.emodeling.log.LogLevel <em>Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  {
    /**
     * The meta object literal for the '{@link org.eclipselabs.emodeling.log.LogEntry <em>Entry</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipselabs.emodeling.log.LogEntry
     * @see org.eclipselabs.emodeling.log.LogPackage#getLogEntry()
    ...
    /**
     * The meta object literal for the '{@link org.eclipselabs.emodeling.log.LogLevel <em>Level</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipselabs.emodeling.log.LogLevel
     * @see org.eclipselabs.emodeling.log.LogPackage#getLogLevel()
